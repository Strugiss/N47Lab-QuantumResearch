...
\textbf{N47Lab} is an independent research initiative conducted by a researcher without formal academic affiliation. This work was conceived, designed, executed, and analyzed by the author, using large language models (LLMs) as \textit{cognitive prostheses} — tools that translate hypotheses into code, formalism, analysis pipelines, and prose.
