...
The complete research process, from the first AI interaction to manuscript submission, is recorded in machine-readable form with schema-validated, typed events (JSON Schema draft-07), each carrying evidence (git commits, QPU job IDs, Z-scores) and an explicit AI role label. The toolchain and the timeline of this study are archived with persistent identifiers (research-timeline, DOI: \url{https://doi.org/10.5281/zenodo.21855315}), providing an auditable, replayable account of the discovery process for independent verification. This decision-point-level documentation follows the process-anchored reporting framework of PAIRED (arXiv:2605.24325), which independently proposed logging AI contributions as structured, auditable records rather than post-hoc disclosure. This study provides a publicly documented, schema-validated, and version-archived implementation of that framework applied to a complete research process. RETTIFICA (01/09/2026): claim of primacy retracted - PAIRED (arXiv:2605.24325, 23/05/2026) precedes this implementation (DOI: \url{https://doi.org/10.5281/zenodo.21855315}).
