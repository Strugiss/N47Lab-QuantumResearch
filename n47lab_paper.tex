...
\begin{itemize}
    \item \textbf{N47Lab} (Paper \& Core Code): \url{https://doi.org/10.5281/zenodo.21830071}
    \item \textbf{PASM Experiments} (Circuits, Data, Analysis): \url{https://doi.org/10.5281/zenodo.21830091}
    \item \textbf{Research Timeline} (CLI Tracking Tool): \url{https://doi.org/10.5281/zenodo.21830095}
\end{itemize}
...
The author acknowledges the broader community of independent researchers using LLMs as cognitive prostheses, including the developers of \textit{The Agentic Researcher} (ZIB-IOL, arXiv:2603.15914), \textit{Research Factory} (GitHub: mindheadllc/research-factory), \textit{JZ Institute of Science} (AI-augmented theoretical physics), \textit{OpenPhysica} (openphysica.org), and the \textit{Independent Research.ai} community. The survey by [arXiv:2411.05025] documenting $>80\%$ LLM adoption among researchers provided context for this work's methodology. IBM Quantum Network is acknowledged for open-plan access to Heron r2 processors.
...
\textbf{N47Lab} is an independent research initiative conducted by a researcher without academic degrees. This work was conceived, designed, executed, and analyzed by the author, using large language models (LLMs) as \textit{cognitive prostheses} — tools that translate hypotheses into code, formalism, analysis pipelines, and prose.

The author is part of a \textit{growing community of independent researchers who use LLMs as cognitive prostheses} (see, e.g., the \textit{The Agentic Researcher} framework [arXiv:2603.15914], the \textit{Research Factory} framework [GitHub: mindheadllc/research-factory], the \textit{JZ Institute of Science} for AI-augmented theoretical physics, the \textit{OpenPhysica} platform, and the \textit{Independent Research.ai} community; surveys indicate $>80\%$ of researchers now use LLMs in their workflow [arXiv:2411.05025]). The central thesis of this work is that \textit{the scientific contribution lies in asking the right questions and interpreting the answers}, not in the mechanical translation of those questions into code, formalism, or prose. The LLMs used here (Claude, GPT-4) served as force multipliers for translation; every scientific decision — experimental design, parameter selection, interpretation pivots, control choices, conclusion framing — was made by the human researcher.

The results reported here (Z $> 50\sigma$ across 14 independent QPU experiments on three IBM Heron backends) are fully reproducible: all circuits, raw data, analysis notebooks, and LaTeX source are publicly available at github.com/Strugiss/pasm-experiments and deposited on Zenodo. The LLMs used are documented in the AI Use Disclosure; no step of the scientific reasoning was delegated.

This work contributes to a growing body of evidence that \textit{independent researchers, augmented by AI as a cognitive prosthesis rather than a replacement for judgment, can produce reproducible, high-significance results on state-of-the-art quantum hardware}.
