...
AI scientists (large language models) were used as cognitive prostheses in protocol design, data analysis, and manuscript preparation. The scientific ideas, experimental evidence, interpretation, and final responsibility for all results remain with the author. The LLMs used (Claude, GPT-4) served as force multipliers for translating hypotheses into code, formalism, analysis pipelines, and prose. Every scientific decision --- experimental design, parameter selection, interpretation pivots, control choices, conclusion framing --- was made by the human researcher.

The complete research process, from the first logged interaction to manuscript submission, is recorded in machine-readable, schema-validated form (JSON Schema draft-07), and each event carries evidence (git commits, QPU job IDs, Z scores) and an explicit AI role (cognitive prosthesis). The tool and the timeline of this study are archived with persistent identifiers (research-timeline, 10.5281/zenodo.21855315; \url{https://github.com/Strugiss/research-timeline}), providing an auditable, time-stamped record of the discovery process that can be independently verified. This decision-point-level documentation follows the process-anchored reporting framework of PAIRED (arXiv:2605.24325), which independently proposed logging AI contributions as structured, auditable records rather than post-hoc disclosure. This study provides a publicly documented, schema-validated, and version-archived implementation of that framework applied to a complete research process. RETTIFICA (01/09/2026): claim of primacy retracted - PAIRED (arXiv:2605.24325, 23/05/2026) precedes this implementation (DOI: 10.5281/zenodo.21855315).
